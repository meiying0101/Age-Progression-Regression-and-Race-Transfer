...
class FaceAging(object):
    ...
    def train(self,
        ...
        for i, j in enumerate(self.image_value_range):
            print("i j ",i,j)
        for i, label in enumerate(sample_files):
            ...
            print("sample_label_age",sample_label_age[i, label])
        ...
        for epoch in range(num_epochs):
            ...
            for ind_batch in range(num_batches):
                ...
                print("\tEG=%.4f\tEz=%.4f\tDz=%.4f\tDzp=%.4f\tGi=%.4f\tDi=%.4f\tDiG=%.4f" % (EG_err,Ez_err, Dz_err, Dzp_err,Gi_err, Di_err, DiG_err))
